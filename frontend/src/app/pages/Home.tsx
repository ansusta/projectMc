...
const categoryImages: Record<string, string> = {
  'pc': 'https://images.unsplash.com/photo-1593642632823-8f785ba67e45?q=80&w=2066&auto=format&fit=crop',
  'components': 'https://images.unsplash.com/photo-1591799264318-7e6ef8ddb7ea?q=80&w=2070&auto=format&fit=crop',
  ...
  'accessories': 'https://images.unsplash.com/photo-1527864550417-7fd91fc51a46?q=80&w=2070&auto=format&fit=crop',
  'peripherals': 'https://images.unsplash.com/photo-1618335829737-2228915674e0?q=80&w=2070&auto=format&fit=crop',
};
...
export function Home() {
  ...
  return (
    <div className="min-h-screen bg-background text-foreground selection:bg-primary/30">
      {/* Hero Section */}
      <section className="relative overflow-hidden bg-black/[0.96] border-b border-white/5 min-h-[700px] flex items-center">
        {/* Spotlight Effect */}
        <Spotlight
        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-20 z-10 w-full">
          <div className="flex flex-col lg:flex-row items-center gap-8">
            ...
            <div className="flex-1 max-w-2xl animate-in fade-in slide-in-from-left-8 duration-1000">
              <h1 className="text-5xl md:text-7xl font-extrabold mb-6 leading-tight tracking-tight text-transparent bg-clip-text bg-gradient-to-r from-white via-primary-foreground to-primary/80">
                Le Futur de la <br />Tech E-commerce
              </h1>
              <p className="text-xl md:text-2xl text-muted-foreground mb-10 max-w-xl font-light">
                Marketplace premium multi-vendeur. Découvrez l'exclusivité au meilleur prix avec une expérience immersive.
              </p>
      ...
      <section className="relative overflow-hidden py-24 border-y border-white/5">
        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 z-10">
          <div className="text-center max-w-2xl mx-auto bg-card/60 backdrop-blur-xl p-12 rounded-3xl border border-white/10 shadow-[0_0_50px_rgba(0,0,0,0.5)]">
            <h2 className="text-4xl font-bold mb-6 text-foreground">Vous êtes vendeur ?</h2>
            <p className="text-lg text-muted-foreground mb-10">
              Rejoignez notre écosystème premium et propulsez vos ventes technologiques avec des milliers de clients potentiels.
            </p>
            <Button
              size="lg"
              variant="glow"
      ...
      <section className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-24">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          <div className="text-center bg-card/20 backdrop-blur-sm p-8 rounded-2xl border border-white/5 hover:border-primary/30 transition-colors group">
            <div className="w-20 h-20 bg-primary/10 rounded-2xl flex items-center justify-center mx-auto mb-6 group-hover:scale-110 transition-transform duration-500 shadow-[inset_0_0_20px_rgba(139,92,246,0.1)]">
              <Package className="w-10 h-10 text-primary drop-shadow-[0_0_10px_rgba(139,92,246,0.5)]" />
            </div>
            <h3 className="text-xl font-bold text-foreground mb-3 tracking-wide">Livraison Warp</h3>
            <p className="text-muted-foreground">Expédition ultra-rapide et sécurisée en 24-48h partout dans l'univers connu.</p>
          </div>
          <div className="text-center bg-card/20 backdrop-blur-sm p-8 rounded-2xl border border-white/5 hover:border-primary/30 transition-colors group">
            <div className="w-20 h-20 bg-primary/10 rounded-2xl flex items-center justify-center mx-auto mb-6 group-hover:scale-110 transition-transform duration-500 shadow-[inset_0_0_20px_rgba(139,92,246,0.1)]">
              <Shield className="w-10 h-10 text-primary drop-shadow-[0_0_10px_rgba(139,92,246,0.5)]" />
            </div>
            <h3 className="text-xl font-bold text-foreground mb-3 tracking-wide">Sécurité Quantique</h3>
            <p className="text-muted-foreground">Transactions cryptées de bout en bout et garantie absolue sur tous les composants.</p>
          </div>
          <div className="text-center bg-card/20 backdrop-blur-sm p-8 rounded-2xl border border-white/5 hover:border-primary/30 transition-colors group">
            <div className="w-20 h-20 bg-primary/10 rounded-2xl flex items-center justify-center mx-auto mb-6 group-hover:scale-110 transition-transform duration-500 shadow-[inset_0_0_20px_rgba(139,92,246,0.1)]">
              <Headphones className="w-10 h-10 text-primary drop-shadow-[0_0_10px_rgba(139,92,246,0.5)]" />
            </div>
            <h3 className="text-xl font-bold text-foreground mb-3 tracking-wide">Support IA & Cybo</h3>
            <p className="text-muted-foreground">Assistance technique 24/7 pour résoudre tous vos problèmes d'incompatibilité.</p>
          </div>
        </div>
      </section>
    </div>

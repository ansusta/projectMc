  ...
  return (
    <div className="min-h-screen pt-24 pb-12 px-4 sm:px-6 lg:px-8 bg-background font-mono">
      <div className="max-w-7xl mx-auto space-y-12">
        ...
        {/* Hero Admin Header */}
        <div className="relative p-10 border border-primary/20 bg-card/40 backdrop-blur-md rounded-2xl overflow-hidden shadow-soft">
            <div className="absolute top-0 right-0 p-6 opacity-10">
                <Activity size={180} className="text-primary" />
            </div>
            <div className="relative z-10">
                <h1 className="text-4xl text-foreground font-bold tracking-[0.2em] italic uppercase">Terminal de Commandement</h1>
        ...
        {/* Financial Snapshot */}
        <div className="bg-card/40 backdrop-blur-xl border border-border/50 p-8 rounded-2xl shadow-soft">
            <div className="flex items-center justify-between mb-8">
                <h2 className="text-lg text-foreground font-bold tracking-widest uppercase italic flex items-center gap-3">
            ...
            <div className="flex items-baseline gap-4">
                <span className="text-6xl font-bold text-foreground tracking-widest">{stats?.revenue?.toLocaleString() || '0'}</span>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 text-foreground text-[10px] font-mono uppercase tracking-[0.2em]">
